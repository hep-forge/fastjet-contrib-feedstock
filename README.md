About fastjet-contrib-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/hep-forge/fastjet-contrib-feedstock/blob/main/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `fastjet-contrib` can be installed with `conda`:

```
conda install fastjet-contrib
```

or with `mamba`:

```
mamba install fastjet-contrib
```
...
Note that all branches in the hep-forge/fastjet-contrib-feedstock are
